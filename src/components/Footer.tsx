            ...
            <footer className='w-full px-[24px] py-[48px] xsm:p-[80px] flex flex-col gap-[80px] text-center xsm:text-start'>
                ...
                <div className='w-full flex flex-col xsm:flex-row justify-between items-center'>
                    <div className='w-[287px] xsm:w-auto flex flex-col xsm:flex-row gap-4'>
                        ...
                        <p className='text-[16px] leading-[150%] font-regular'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                    <div className='flex gap-4 flex-col mt-[24px] xsm:mt-0'>
                        <div className='flex gap-4 flex-col xsm:flex-row'>
                            <Input placeholder='Enter your email' className='w-full xsm:w-[265px] h-[48px] border-black' />
                            <Button variant={"myBtn"} className='w-full xsm:w-auto' >Subscribe</Button>
                        </div>
                ...
                <div className='w-full flex flex-col xsm:flex-row gap-10 text-center'>
                    <div className='xsm:w-[250px] h-[40px] inline-block xsm:block m-auto xsm:m-0'>
                        <Image src="/weblogo.png" alt="weblogo" width={130} height={40}></Image>
                    </div>

                    {footerLinks.map((item, index) => {
                        return (
                            <div className='w-[250px] flex flex-col gap-4 m-auto xsm:text-start' key={index}>
                                <h4 className='text-[16] leading-[150%] font-semibold'>{item.heading}</h4>
